...
export class AppMenuComponent implements OnInit, AfterViewInit {
    ...
    ngOnInit() {
        this.model = [
            { label: 'Posición Consolidada', icon: 'fa fa-fw fa-area-chart', routerLink: ['/template/main'] },


            {
                label: 'Transferencias', icon: 'fa fa-exchange',
                items: [
                    { label: 'Transferencia Directa', routerLink: ['/template/transfdirecta'] },
                    { label: 'Transferencia Otros', routerLink: ['/template/transfotros'] },
                    { label: 'Historial', routerLink: ['/template/transfhistorial'] }
            ...
            {
                label: 'Préstamos', icon: 'fa fa-money',
                items: [
                    { label: 'Solicitud de Préstamo', routerLink: ['/template/solicitudp'] },
                    { label: 'Simulador de Préstamo', routerLink: ['/template/simuladorp'] },
                    { label: 'Pago de Préstamo', routerLink: ['/template/pagosp'] },
                ]
            },
            { label: 'Movimientos', icon: 'fa fa-spinner', routerLink: ['/template/movimientos'] },
        ];
    }
